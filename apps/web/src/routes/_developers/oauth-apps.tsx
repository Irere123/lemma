...
export const Route = createFileRoute('/_developers/oauth-apps')({
  component: RouteComponent,
  head: () => ({
    meta: [{ title: 'OAuth Applications' }],
  }),
})
      ...
      <div className='space-y-8'>
        ...
        <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              <h1 className='font-semibold text-2xl tracking-tight'>OAuth Applications</h1>
              <p className='text-muted-foreground text-sm'>
                Manage your OAuth applications and integrations
              </p>
            </div>
          </div>
          ...
          <TabsContent value='my-apps' className='mt-6'>
            <div className='space-y-4'>
              <div className='rounded-lg border bg-muted/30 p-4'>
                <h3 className='mb-1 font-medium'>Build integrations with Lemma</h3>
                <p className='text-muted-foreground text-sm'>
                  Create OAuth applications to allow users to connect their Lemma account to your
                  service. Use the OAuth 2.0 protocol to securely access user data.
                </p>
              </div>
              <OAuthAppsTable />
            </div>
...
function AuthorizedAppsSection() {
  return (
    <div className='space-y-4'>
      <div className='rounded-lg border bg-muted/30 p-4'>
        <h3 className='mb-1 font-medium'>Apps with access to your account</h3>
        <p className='text-muted-foreground text-sm'>
          These are third-party applications that have been granted access to your Lemma account.
  ...
  if (!apps || apps.length === 0) {
    return (
      <div className='flex flex-col items-center justify-center rounded-lg border border-dashed py-12'>
        ...
        <h3 className='mb-1 font-semibold'>No Authorized Applications</h3>
        <p className='text-muted-foreground text-sm'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-muted-foreground text-xs'>
                Authorized {formatDistanceToNow(new Date(app.authorizedAt), { addSuffix: true })}
              </p>
            </div>
          </div>
          <Button
