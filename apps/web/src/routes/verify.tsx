    ...
    <main className='mx-auto max-w-3xl px-6 py-10'>
      ...
      <section className='space-y-6'>
        ...
        <div className='p-6 bg-white rounded-lg shadow-md border border-gray-200'>
          {isPending && (
            <div className='flex items-center gap-3 p-4 bg-blue-50 border border-blue-200 rounded-md'>
              ...
              <p className='text-sm text-blue-900'>Confirming your subscription...</p>
            </div>
          )}
            ...
            <div className='space-y-4'>
              <div className='flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-md'>
                ...
                <div className='flex-1'>
                  <p className='text-sm font-medium text-green-900'>Subscription Confirmed! 🎉</p>
                  <p className='text-xs text-green-700 mt-1'>
                    You're all set! You'll now receive our newsletter with the latest articles and
                    updates.
                  </p>
                </div>
              </div>
              ...
              <div className='space-y-3'>
                ...
                <ul className='space-y-2 text-sm text-neutral-700'>
                  <li className='flex items-start gap-2'>
                    ...
                    <span>You'll receive an email when we publish new content</span>
                  </li>
                  <li className='flex items-start gap-2'>
                    <span className='text-purple-600 mt-1'>✓</span>
          ...
          {isError && (
            <div className='space-y-4'>
              <div className='flex items-start gap-3 p-4 bg-red-50 border border-red-200 rounded-md'>
                ...
                <div className='flex-1'>
                  <p className='text-sm font-medium text-red-900'>Confirmation Failed</p>
          ...
          {!isPending && !isSuccess && !isError && token && (
            <div className='space-y-4'>
              <div className='flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-md'>
                ...
                <div className='flex-1'>
                  <p className='text-sm font-medium text-amber-900'>Ready to Confirm</p>
          ...
          {!token && !isPending && !isSuccess && (
            <div className='space-y-4'>
              <div className='flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-md'>
                ...
                <div className='flex-1'>
                  <p className='text-sm font-medium text-gray-900'>No Confirmation Token</p>
        ...
        <div className='space-y-3 pt-4 border-t'>
          <h3 className='text-lg font-semibold text-gray-900'>Why confirm your email?</h3>
          <p className='text-sm text-neutral-700'>
            We require email confirmation to ensure that you actually want to receive our newsletter
            and to protect against spam. This also helps us maintain a high-quality mailing list.
          </p>
        </div>
      </section>
    </main>
