/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env local` (hash: af2eaf6e47ac501bcbe1742d637a8f5d)
// Runtime types generated with workerd@1.20251217.0 2025-09-02 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cf-worker");
		durableNamespaces: "CampaignProgress" | "WriterStats";
	}
	interface Env {
		CACHE: KVNamespace;
		ENV: "local" | "production";
		ALLOWED_API_ORIGINS: "http://localhost:3000,http://localhost:5173";
		BASE_URL: "http://localhost:4000" | "https://api.irere.dev";
		FRONTEND_URL: "http://localhost:3000" | "https://lemma.irere.dev";
		BETTER_AUTH_URL: "http://localhost:4000" | "https://api.irere.dev";
		CLOUDFLARE_ACCOUNT_ID: "00000000000000000000000000000000" | "c2c7b2ff17bd68a351ee368bddfad7d9";
		R2_BUCKET_URL: "https://00000000000000000000000000000000.r2.cloudflarestorage.com/lemma-local-assets" | "https://assets.irere.dev";
		R2_STORAGE_BASE_URL: "http://localhost:4000/assets" | "https://assets.irere.dev";
		RESEND_DOMAIN: "localhost" | "updates.irere.dev";
		...
		CAMPAIGN_PROGRESS: DurableObjectNamespace<import("./src/cf-worker").CampaignProgress>;
		WRITER_STATS: DurableObjectNamespace<import("./src/cf-worker").WriterStats>;
		R2_BUCKET: R2Bucket;
		DB: D1Database;
		EMAIL_QUEUE: Queue;
