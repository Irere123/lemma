...
export const oauthAuthorizationRequestSchema = z.object({
  ...
  client_id: z.string().openapi({
    ...
    example: 'lemm_client_abcdef123456789',
  }),
  ...
  scope: z.string().openapi({
    ...
    example: 'documents.read feeds.read',
  }),
...
export const oauthTokenRequestSchema = z
  .object({
    ...
    code: z.string().openapi({
      ...
      example: 'lemm_authorization_code_abcdef123456789',
    }),
    redirect_uri: z.string().url().openapi({
    ...
    client_secret: z.string().optional().openapi({
      ...
      example: 'lemm_secret_abcdef123456789',
    }),
...
export const oauthRefreshTokenRequestSchema = z.object({
  ...
  refresh_token: z.string().openapi({
    ...
    example: 'lemm_rt_abcdef123456789',
  }),
  client_id: z.string().openapi({
    description: 'Client ID of the OAuth application',
    example: 'lemm_client_abcdef123456789',
...
export const oauthTokenResponseSchema = z.object({
  access_token: z.string().openapi({
    ...
    example: 'lemm_access_token_abcdef123456789',
  }),
  ...
  refresh_token: z.string().openapi({
    ...
    example: 'lemm_refresh_token_abcdef123456789',
  }),
  scope: z.string().openapi({
...
export const oauthApplicationInfoSchema = z.object({
  ...
  name: z.string().openapi({
    ...
    example: 'My Music App',
  }),
  description: z.string().nullable().openapi({
    description: 'Application description',
    example: 'A Music app for managing your music library',
  }),
  overview: z.string().nullable().openapi({
    description: 'Application overview',
    example:
      'This application provides advanced music management features including:\n- Real-time sync\n- Advanced filtering',
  }),
