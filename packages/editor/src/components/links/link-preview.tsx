import { CopyIcon, EditIcon, GlobeIcon, Link2Off } from 'lucide-react'
// components
...
export function LinkPreview({
  ...
  return (
    ...
    >
      <div className='shadow-md items-center rounded-sm p-2 flex gap-3 bg-muted border-border/50 border-2 text-muted-foreground text-xs'>
