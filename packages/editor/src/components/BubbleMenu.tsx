...
export function BubbleMenu({ className }: BubbleMenuProps) {
  ...
  const { refs, floatingStyles } = useFloating({
    open: !!selectionRect,
    placement: 'top',
    middleware: [offset(8), flip({ fallbackPlacements: ['bottom', 'top'] }), shift({ padding: 8 })],
  ...
  return (
    <div ref={refs.setFloating} style={floatingStyles} className={`bubble-menu ${className || ''}`}>
      {showLinkInput ? (
...
function BoldIcon() {
  return (
    <svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M3.5 2.5H8C9.38071 2.5 10.5 3.61929 10.5 5C10.5 6.38071 9.38071 7.5 8 7.5H3.5V2.5Z'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
      ...
      />
      <path
        d='M3.5 7.5H8.5C9.88071 7.5 11 8.61929 11 10C11 11.3807 9.88071 12.5 8.5 12.5H3.5V7.5Z'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
...
function ItalicIcon() {
  return (
    <svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M5.5 12.5H8.5M5.5 2.5H8.5M8 2.5L6 12.5'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
...
function UnderlineIcon() {
  return (
    <svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M3.5 2.5V7C3.5 9.20914 5.29086 11 7.5 11C9.70914 11 11.5 9.20914 11.5 7V2.5M2.5 13H12.5'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
...
function StrikethroughIcon() {
  return (
    <svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M2 7H12M4.5 3.5H9.5C10.6046 3.5 11.5 4.39543 11.5 5.5C11.5 6.05228 11.2761 6.55228 10.9142 6.91421M4.5 11.5H9.5C10.6046 11.5 11.5 10.6046 11.5 9.5C11.5 8.94772 11.2761 8.44772 10.9142 8.08579'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
...
function HighlightIcon() {
  return (
    <svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M8.5 2L2.5 8L4 9.5L5.5 11L11.5 5L8.5 2Z'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
...
function LinkIcon() {
  return (
    <svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
        d='M6 8C6.55228 8.55228 7.44772 8.55228 8 8L10 6C11.1046 4.89543 11.1046 3.10457 10 2C8.89543 0.895431 7.10457 0.895431 6 2L5 3'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
      />
      <path
        d='M8 6C7.44772 5.44772 6.55228 5.44772 6 6L4 8C2.89543 9.10457 2.89543 10.8954 4 12C5.10457 13.1046 6.89543 13.1046 8 12L9 11'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
      />
