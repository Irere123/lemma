  ...
  return (
    <FloatingMenuRoot
      classNames={{
        ...
        button:
          'flex items-center gap-1 h-full whitespace-nowrap px-3 text-sm font-medium text-muted-foreground hover:bg-muted active:bg-muted rounded-sm transition-colors',
      }}
      menuButton={
        <>
          <span>Color</span>
          <span
            className={cn(
              'flex-shrink-0 size-6 grid place-items-center rounded-sm border-[0.5px] border-border',
              {
                'bg-card': !activeBackgroundColor,
              }
            )}
            style={{
          ...
          >
            <ALargeSmall
              className={cn('size-3.5', {
                'text-foreground': !activeTextColor,
              })}
              style={{
    ...
    >
      <section className='mt-1 rounded-md border-[0.5px] border-border bg-card p-2 space-y-2 shadow-md'>
        <div className='space-y-1.5'>
          <p className='text-xs text-muted-foreground font-semibold'>Text colors</p>
          <div className='flex items-center gap-2'>
            ...
            <button
              type='button'
              className='flex-shrink-0 size-6 grid place-items-center rounded-sm text-muted-foreground border-[0.5px] border-border/80 hover:bg-muted transition-colors'
