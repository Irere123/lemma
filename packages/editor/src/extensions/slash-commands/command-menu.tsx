...
// lib
import { useOutsideClickDetector } from '@/lib/hooks'
// types
  ...
  return (
    <>
      ...
      <div
        ...
        className='relative max-h-80 min-w-[12rem] overflow-y-auto rounded-md border-[0.5px] border-border bg-card px-2 py-2.5 shadow-md space-y-2'
        style={{
          zIndex: 100,
        }}
        onClick={(e) => {
