...
export function CommandMenuItem(props: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        'flex items-center gap-2 w-full rounded-sm px-1 py-1.5 text-sm text-left truncate text-muted-foreground hover:bg-muted/80',
        {
    ...
    >
      ...
      <p className='flex-grow truncate text-12'>
