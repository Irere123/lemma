    ...
    <EmailThemeProvider preview={<Preview>{previewText}</Preview>}>
      ...
      >
        ...
        >
          ...
          <Link
            href={documentUrl}
            className={`block text-center my-[32px] p-[12px_24px] text-white rounded-md text-sm font-medium no-underline ${themeClasses.button}`}
            style={{
              backgroundColor: writerSettings.brandColor,
              color: "#fff",
            }}
          >
            Read full article
