      ...
      <section className="space-y-6">
          ...
          {isPending && (
            <div className="flex items-center gap-3 p-4 bg-blue-50 border border-blue-200 rounded-md">
              ...
              <p className="text-sm text-blue-900">
                Unsubscribing you from the newsletter...
              </p>
            </div>
          )}
              ...
              <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-md">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-green-700 mt-1">
                    You have been removed from our mailing list. You will no
                    longer receive newsletter emails from us.
                  </p>
                </div>
              </div>
          ...
          {!token && !isPending && !isSuccess && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">
                If you're having trouble unsubscribing, please contact us
                directly.
              </p>
            </div>
          )}
        ...
        <div className="space-y-3 pt-4">
          ...
          <p className="text-sm text-neutral-700">
            We understand that your inbox is precious. If our content wasn't
            what you expected or if you're receiving too many emails, we'd love
            to hear your feedback to improve our newsletter.
          </p>
          <p className="text-sm text-neutral-700">
